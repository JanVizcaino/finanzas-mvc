...
<form action="index.php?action=update_plan" method="POST" class="flex flex-col gap-4 mb-8">
    ...
    <div class="flex gap-6">
        ...
        <div class="flex-1 flex flex-col gap-1.5">
            ...
            <div class="relative">
                <select class="w-full h-10 px-3 bg-white border border-secondary/30 rounded-md text-sm text-text shadow-sm appearance-none focus:outline-none focus:border-primary">
                    <option>Euros (€)</option>
                    <option>USD ($)</option>
                </select>
    ...
    <div class="flex flex-col gap-1.5">
        ...
        <textarea name="description" class="w-full p-3 bg-white border border-secondary/30 rounded-md text-sm text-text shadow-sm h-24 resize-none focus:outline-none focus:border-primary"><?= htmlspecialchars($plan['description'] ?? '') ?></textarea>
    </div>
</form>
...
<div class="flex justify-end gap-5 mt-4">
    ...
    <button type="submit" class="h-10 px-4 bg-primary hover:opacity-90 transition rounded-md flex items-center gap-2 text-white text-sm font-medium shadow-sm cursor-pointer">
