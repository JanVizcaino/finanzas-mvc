<?php 
    // Variable auxiliar para simplificar la lógica en la vista
    $isAdmin = ($currentUserRole === 'admin'); 
    
    // Define las columnas de la tabla según el rol
    $gridColsClass = $isAdmin ? 'grid-cols-5' : 'grid-cols-4';
?>
...
<div class="flex flex-col gap-4 mb-8">
    ...
    <div class="bg-white rounded-md shadow-sm flex flex-col overflow-hidden">
        ...
        <div class="grid <?= $gridColsClass ?> gap-4 px-6 py-3 border-b border-secondary/10 bg-secondary/5">
        ...
        <?php foreach ($members as $member): ?>
            <div class="grid <?= $gridColsClass ?> gap-4 px-6 py-4 items-center border-b border-secondary/10 hover:bg-secondary/5 transition">
